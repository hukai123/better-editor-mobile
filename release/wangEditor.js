...
function Video(editor) {
    ...
    this.$elem = $('<div class="w-e-menu" id="' + videoMenuId + '"><i class="w-e-icon-play"></i><input id="' + upFileVideoId + '" style="display:none;" type="file" multiple="multiple" accept="video/*" /></div>');
    // this.type = 'panel';
    this.type = 'click';
...
function Image(editor) {
    ...
    this.$elem = $('<div class="w-e-menu" id="' + imgMenuId + '"><i class="w-e-icon-image"></i><input id="' + upFileId + '" style="display:none;" type="file" multiple="multiple" accept="image/*" /></div>');
...
Text.prototype = {
    ...
    _enterKeyHandle: function _enterKeyHandle() {
        ...
        function codeHandle(e) {
            ...
            // console.log('selectionNodeName',selectionNodeName);
            // console.log('parentNodeName',parentNodeName);
            
            // 此时可以跳出代码块      for  mobile
            // 插入 <p> ，并将选取定位到 <p>
            if(selectionNodeName=='P'){
                var $p = $('<p><br></p>');
